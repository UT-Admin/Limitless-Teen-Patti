...
public class HOWTOPLAY : MonoBehaviour
{
    ...
    public string Format(string rawText)
    {
       ...
       // string boldStyleLeft = "<size=40><b><alpha=#FF>", boldStylRight = "</b></size><alpha=#90>";
        string semiBoldStyleLeft = "<size=50><b><alpha=#FF>", semiBoldStyleRight = "</b></size><alpha=#90>";
        string boldStyleLeft = "<size=50><b><alpha=#FF><color=#FB9718>", boldStylRight = "</b></color></size><alpha=#90>";
